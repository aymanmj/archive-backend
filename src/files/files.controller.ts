...
export class FilesController {
  ...
  // فحص الخدمة (بدون حارس)
  @Get('ping')
  ping() {
    return { ok: true, msg: 'files service up' };
  }

  // رفع مرفق لوثيقة: يقبل حقل واحد اسمه "file" (حتى 5 ملفات لو أردت)
  ...
  // (اختياري) جلب قائمة ملفات وثيقة
  @UseGuards(JwtAuthGuard)
  @Get('document/:documentId')
  async listDocumentFiles(@Param('documentId') documentId: string) {
    return this.filesService.listDocumentFiles(documentId);
  }
}
